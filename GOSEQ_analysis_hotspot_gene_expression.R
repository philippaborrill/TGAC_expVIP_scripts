...
hotspot_genes <- read.csv("hotspot_genes.csv", header=T)
head(hotspot_genes,20)

list_of_regions <- c("1D_131.936", "2A_18.219", "5D_126.335")
...
gene_table <- hotspot_genes[ grep(list_of_regions[i],hotspot_genes$chr_cM),]
