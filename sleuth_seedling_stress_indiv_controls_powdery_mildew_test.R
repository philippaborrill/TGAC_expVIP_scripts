...
# Run sleuth
library("sleuth")
setwd("Y:\\expression_browser\\TGAC_assembly\\analysis\\seedling_stress_analysis\\SRP041017_powdery_mildew")

# set base directory 
base_dir <- "Y:\\expression_browser\\TGAC_assembly\\analysis\\seedling_stress_analysis\\SRP041017_powdery_mildew"

# set directory of files to work with
samples_to_use <- "24_hours"
...
s2c <- read.table ("Y:\\expression_browser\\TGAC_assembly\\analysis\\seedling_stress_analysis\\SRP041017_powdery_mildew\\SRP041017_powdery_mildew_24hours.txt",sep="\t", header = TRUE, stringsAsFactors=FALSE)
s2c
...
write.csv(edited_results_table, "Powdery mildew pathogen E09 24 hours_sorted_abundances_q_value_under_0.05_test_only_1_condition.csv")
